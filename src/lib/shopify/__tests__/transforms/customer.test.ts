    ...
    edges: [
      {
        node: {
          ...
          customAttributes: [
            { key: "_slug", value: "on" },
            { key: "_has_logo", value: "true" },
            { key: "_base_unit_price", value: "2200" },
            { key: "_color_name", value: COLOR_OPTION.name },
            { key: "_color_name_en", value: COLOR_OPTION.nameEn },
            { key: "_color_upper_hex", value: COLOR_OPTION.upperHex },
            { key: "_color_lower_hex", value: COLOR_OPTION.lowerHex },
            {
              key: "logo_url",
